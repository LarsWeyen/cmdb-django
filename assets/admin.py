...
from .models import Asset, Customer, LCD, Location, Type, Camera, DVR, LCB, QRScanner, RFID, Switch, Router, Distrispot, IPC, PowerSupply,DistrispotType
...
admin.site.register(DistrispotType)